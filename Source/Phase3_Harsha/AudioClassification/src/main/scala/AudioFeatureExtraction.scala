...
object AudioFeatureExtraction {
  ...
  def main(args: Array[String]) {
    ...
    val features = AudioFeatureExtraction("data/wav/ProsantaChakrabarty.wav")
  ...
  def feature(audio: AudioSamples, i: AudioFeature.Value): Array[Double] = {
    ...
    val samples: Array[Array[Double]] = audio.getSampleWindowsMixedDown(28250)
    val featureMeanSampleArray  = new Array[Double](10000)
    val sampleRate: Double = 4100
    val otherFeatures = Array.ofDim[Double](10000, 10000)
