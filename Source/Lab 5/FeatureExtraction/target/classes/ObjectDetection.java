...
//    private RenderMode renderMode = RenderMode.SQUARE;
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/classvideo.mkv"));
        int count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0;
        String o1 = "output/studentfeatures.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/nikhita.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/aparna.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/harsha.png"));
            modelImage4 = ImageUtilities.readMBF(new File("data/ganesh.png"));
