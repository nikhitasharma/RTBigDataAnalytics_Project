...
public class StormKafkaMain {
    private static final String KAFKA_TOPIC ="group3_test";
    ...
    private static StormTopology createTopology()
    {
        ...
        topology.setSpout("recieve_audioFeatures", new KafkaSpout(kafkaConf), 4);
//        topology.setBolt("DataExtraction", new DataExtractionBolt(), 4)
//                .shuffleGrouping("kafka_spout");
         topology.setBolt("AudioBolt", new AudioBolt(), 4)
                .shuffleGrouping("recieve_audioFeatures");
