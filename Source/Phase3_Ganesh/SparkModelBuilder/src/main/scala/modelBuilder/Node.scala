...
/**
  * :: DeveloperApi ::
  * modelBuilder.Node in a decision tree.
  *
  * About node indexing:
  *   Nodes are indexed from 1.  modelBuilder.Node 1 is the root; nodes 2, 3 are the left, right children.
  *   modelBuilder.Node index 0 is not used.
  *
