...
public class FacialRecognition {
    public static final String IMAGE_SAMPLE_DIR = "D:\\";
    public static final int IMAGE_GROUP_MAX = 50;
    public static final String SAMPLE_IMAGE = IMAGE_SAMPLE_DIR + "LS-2016-DEN-Slider.PNG";
    public static final String QUERY_IMAGE = IMAGE_SAMPLE_DIR + "LS-2016-DEN-Slider.PNG";
    ...
    public static final void main(String[] args) {
        try {
            ...
            //computeFindFace(MBFImage SAMPLE_IMAGE, MBFImage QUERY_IMAGE);
